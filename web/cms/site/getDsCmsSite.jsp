...
$(function(){
	$dswork.page.menu("delDsCmsSite.jsp", "updDsCmsSite1.jsp", "getDsCmsSiteById.jsp", "${pageModel.currentPage}");
});
$dswork.doAjax = true;
$dswork.callback = function(){if($dswork.result.type == 1){
	location.href = "getDsCmsSite.jsp?page=${pageModel.currentPage}";
}};
</script>
</head> 
<body>
<table border="0" cellspacing="0" cellpadding="0" class="listLogo">
	<tr>
		...
		<td class="menuTool">
			<a class="insert" href="addDsCmsSite1.jsp?page=${pageModel.currentPage}">添加</a>
